...
class ViewController: NSViewController, DanmakuProtocol {
    ...
    override func viewDidLoad() {
        ...
        self.danmakuWindow = self.storyboard?.instantiateController(withIdentifier: NSStoryboard.SceneIdentifier("DanmakuWindow")) as? DanmakuWindowController
    ...
    func handleMsg(msg: Message) {
        ...
        let attrNormal, attrGift, attrUser, attrWelcome, attrWelcGuard, attrAdmin: [NSAttributedStringKey: Any]
        // white
        attrNormal = [.foregroundColor: NSColor(red: 1, green: 1, blue: 1, alpha: 1),
                      .font: font1]
        // orange
        attrGift = [.foregroundColor: NSColor(red: 1, green: 0.709, blue: 0.134, alpha: 1),
                    .font: font1]
        // blue
        attrUser = [.foregroundColor: NSColor(red: 0.31, green: 0.757, blue: 0.914, alpha: 1),
                    .font: font1]
        // red
        attrWelcome = [.foregroundColor: NSColor(red: 1, green: 0.426, blue: 0.627, alpha: 1),
                       .font: font1]
        // green
        attrWelcGuard = [.foregroundColor: NSColor(red: 0.663, green: 1, blue: 0.388, alpha: 1),
                         .font: font1]
        // purple
        attrAdmin = [.foregroundColor: NSColor(red: 0.708, green: 0.59, blue: 1, alpha: 1),
                     .font: font1]
        ...
        let attrLogTitle: [NSAttributedStringKey: Any] = [.foregroundColor: NSColor(red: 0.31, green: 0.757, blue: 0.914, alpha: 1),
                                                          .font: font2]
        let attrLogContent: [NSAttributedStringKey: Any] = [.foregroundColor: NSColor(red: 0.3, green: 0.3, blue: 0.3, alpha: 1),
                                                            .font: font2]
